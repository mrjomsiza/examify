...
export const StudentProfilePage = () => {
  ...
  return (
    <AppShell title="Profile" subtitle="Review your learner profile, tutor assignment context, onboarding mark, and payment state." role="student" user={profile} onLogout={logout}>
